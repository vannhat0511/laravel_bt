	...
	        <th scope="col">New</th>															
	        <th scope="col"><a href="/luan9/" class="btn btn-primary" style="width:80px;">Add</a></th>															
	      </tr>															
	    </thead>															
	    <tbody>															
	...
	        <td>{{$product->new}}</td>															
	        <td>															
	          <a href='/luan10/{{$product->id}}' type="submit" class="btn btn-warning" style="width:80px;">Edit</a>															
	          <form role="form" action="/luan11/{{$product->id}}" method="post">															
	            @csrf															
